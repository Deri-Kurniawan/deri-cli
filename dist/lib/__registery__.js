...
const __instance__1 = __importDefault(require("./__instance__"));
const cli_help_1 = __importDefault(require("./commands/cli-help"));
const pkg_installer_1 = __importDefault(require("./commands/pkg-installer"));
const pkg_uninstaller_1 = __importDefault(require("./commands/pkg-uninstaller"));
const pkg_updater_1 = __importDefault(require("./commands/pkg-updater"));
...
exports.default = commandsRegistery;
